	...
	<view class="content">
		<form class="app-update-pv">
            ...
            <view
                    ...
                    class="cu-form-group">
                <view :style='{"width":"160rpx","fontSize":"28rpx","color":"#008761","textAlign":"left"}'
                      class="title">维修员姓名</view>
                <input   disabled
                         :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"#008761","borderRadius":"0px","color":"#008761","textAlign":"left","borderWidth":"0 0 6rpx","fontSize":"24rpx","borderStyle":"solid","height":"68rpx"}'
                         :disabled="ro.weixiuyuanName" type="text" v-model="ruleForm.weixiuyuanName" placeholder="维修员姓名"></input>
            </view>
            ...
            <view
                    ...
                    class="cu-form-group">
                <view :style='{"width":"160rpx","fontSize":"28rpx","color":"#008761","textAlign":"left"}'
                      class="title">工作年限</view>
                <input   disabled
                         :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"#008761","borderRadius":"0px","color":"#008761","textAlign":"left","borderWidth":"0 0 6rpx","fontSize":"24rpx","borderStyle":"solid","height":"68rpx"}'
                         :disabled="ro.weixiuyuanNianxian" type="text" v-model="ruleForm.weixiuyuanNianxian" placeholder="工作年限"></input>
            </view>
            <view
                    :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"88rpx"}'
                    class="cu-form-group">
                ...
                <input   disabled
                         :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"#008761","borderRadius":"0px","color":"#008761","textAlign":"left","borderWidth":"0 0 6rpx","fontSize":"24rpx","borderStyle":"solid","height":"68rpx"}'
                         :disabled="ro.weixiuyuanPhone" type="text" v-model="ruleForm.weixiuyuanPhone" placeholder="联系方式"></input>
            </view>
                <view
                        ...
                        class="cu-form-group" @tap="weixiuyuanPhotoTap">
                    <view :style='{"width":"160rpx","fontSize":"28rpx","color":"#008761","textAlign":"left"}'
                          class="title">照片</view>
                    <view class="right-input" style="padding:0;textAlign:left">
                        <image
                                ...
                                class="avator" v-if="ruleForm.weixiuyuanPhoto" :src="ruleForm.weixiuyuanPhoto" mode="aspectFill">
                        </image>
            ...
            <view
                    ...
                    class="cu-form-group">
                <view :style='{"width":"160rpx","fontSize":"28rpx","color":"#008761","textAlign":"left"}'
                      class="title">维修人员介绍</view>
                <textarea :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"#008761","borderRadius":"0px","color":"#008761","textAlign":"left","borderWidth":"0 0 6rpx","fontSize":"24rpx","borderStyle":"solid","height":"68rpx","height":"200rpx"}'
                          :disabled="ro.weixiuyuanContent" v-model="ruleForm.weixiuyuanContent" placeholder="维修人员介绍"/>
            </view>
	...
	export default {
		...
		/*下拉框*/
			...
			if (options.id) {
				...
				// 获取信息
				let res = await this.$api.info(`weixiuyuan`, this.ruleForm.id);
				this.ruleForm = res.data;
			}
			if(options.weixiuyuanId){
                this.ruleForm.weixiuyuanId = options.weixiuyuanId;
			}
			// 跨表
			// this.styleChange()
		},
		methods: {
			...
			weixiuyuanPhotoTap() {
				...
				this.$api.upload(function(res) {
					_this.ruleForm.weixiuyuanPhoto = _this.$base.url + 'upload/' + res.file;
					_this.$forceUpdate();
					_this.$nextTick(() => {
						// _this.styleChange()
					})
			...
			async onSubmitTap() {
				...
				if ((!this.ruleForm.weixiuyuanName)) {
					this.$utils.msg(`维修员姓名不能为空`);
					return
				}
				...
				if ((!this.ruleForm.weixiuyuanNianxian)) {
					this.$utils.msg(`工作年限不能为空`);
					return
				}
				if ((!this.ruleForm.weixiuyuanPhone) && (!this.$validate.isMobile(this.ruleForm.weixiuyuanPhone))) {
					this.$utils.msg(`联系方式不能为空并且需要输入正确格式`);
					return
				}
				if ((!this.ruleForm.weixiuyuanPhoto)) {
				...
				if (this.ruleForm.id) {
					...
					await this.$api.save(`weixiuyuan`, this.ruleForm);
				}
