		...
		<form class="app-update-pv">
            <view
                ...
                <input   disabled
                         ...
                         :disabled="ro.newsName" type="text" v-model="ruleForm.newsName" placeholder="新闻信息标题"></input>
            </view>
            ...
            <view
                ...
                <textarea :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"#008761","borderRadius":"0px","color":"#008761","textAlign":"left","borderWidth":"0 0 6rpx","fontSize":"24rpx","borderStyle":"solid","height":"68rpx","height":"200rpx"}'
                          :disabled="ro.newsContent" v-model="ruleForm.newsContent" placeholder="新闻信息详情"/>
            </view>
		...
		methods: {
			...
			async onSubmitTap() {
				if ((!this.ruleForm.newsName)) {
					this.$utils.msg(`新闻信息标题不能为空`);
					return
				}
				if ((!this.ruleForm.newsPhoto)) {
					this.$utils.msg(`新闻信息图片不能为空`);
					return
				}
				if (this.ruleForm.id) {
